...
### 🔐 Web3 Developer & Privacy Researcher · Indonesia 🇮🇩
...
```typescript
const eyren: Developer = {
  location: "Indonesia 🇮🇩",
  role: "Web3 Developer & Privacy Researcher",
  currentlyBuilding: [
    "Privacy-preserving DEX (Homomorphic Encryption)",
...
| **Web3** | ![Ethereum](https://img.shields.io/badge/Ethereum-3C3C3D?style=flat-square&logo=ethereum&logoColor=white) ![Hardhat](https://img.shields.io/badge/Hardhat-FFC107?style=flat-square&logo=hardhat&logoColor=black) ![Foundry](https://img.shields.io/badge/Foundry-000000?style=flat-square&logo=data:image/png;base64,) ![Circom](https://img.shields.io/badge/Circom-4E2BFF?style=flat-square) ![Noir](https://img.shields.io/badge/Noir-000000?style=flat-square) |
